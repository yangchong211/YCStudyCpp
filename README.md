...
#### 2.2 联动系统媒体播放器
- **2.2.1 播放器除了播放了音乐之外什么都没做，就可以分别在任务管理、锁屏、负一屏控制播放器。**
...
#### 2.6 滑动通知栏可以关闭程序
- 2.6.1 这一步操作和点击退出程序逻辑一样


### 3.关于项目架构的技术堆栈
#### 3.1 该项目App整体架构
- **3.1.1 目前项目准备采用MVP+Rx+Retrofit+Vlayout+ijkplayer**
- MVP是代码架构，Rx+Retrofit是网络请求框架，Vlayout是阿里出的处理复杂UI界面框架，ijkplayer是bilibili公司出的音视频播放框架
- **3.1.2 bug管理**
