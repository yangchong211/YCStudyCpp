 ...
 * </pre>
 */
public class HHNotificationUtils extends ContextWrapper {
    ...
    public HHNotificationUtils(Context base) {
        super(base);
     ...
     * @return
     */
    public HHNotificationUtils setOngoing(boolean ongoing){
     ...
     * @return
     */
    public HHNotificationUtils setContent(RemoteViews remoteViews){
     ...
     * @return
     */
    public HHNotificationUtils setContentIntent(PendingIntent intent){
        this.intent = intent;
        return this;
    }
     ...
     * @return
     */
    public HHNotificationUtils setTicker(String ticker){
        this.ticker = ticker;
        return this;
    }
     ...
     * @return
     */
    public HHNotificationUtils setPriority(int priority){
     ...
     * @return
     */
    public HHNotificationUtils setOnlyAlertOnce(boolean onlyAlertOnce){
     ...
     * @return
     */
    public HHNotificationUtils setWhen(long when){
        this.when = when;
        return this;
    }
     ...
     * @return
     */
    public HHNotificationUtils setSound(Uri sound){
        this.sound = sound;
        return this;
    }
     ...
     * @return
     */
    public HHNotificationUtils setDefaults(int defaults){
     ...
     * @return
     */
    public HHNotificationUtils setVibrate(long[] pattern){
     ...
     * @return
     */
    public HHNotificationUtils setFlags(int... flags){
        this.flags = flags;
        return this;
    }
