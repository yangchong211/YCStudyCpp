...
import cn.ycbjie.ycaudioplayer.ui.study.ui.adapter.LocalOfficeAdapter;
    ...
    public void initData() {
        ...
        executor.async(new Callable<List<OfficeBean>>() {
            ...
            public List<OfficeBean> call() throws Exception {
                ...
                List<OfficeBean> officeBeans = instance.getFilesByType(LocalZipFileActivity.this, FileOfficeScanManager.TYPE_ZIP);
